...
public:
  ...
  float getAngle() { return atan2f(y, x); }
};
...
public:
  ...
  /** Gets the number of degrees to rotate a particle around the source pos per
   * second.
   *
   * @return The number of degrees to rotate a particle around the source pos
   * per second.
   */
  virtual float getRotatePerSecond() const;
  /** Sets the number of degrees to rotate a particle around the source pos per
   * second.
   *
   * @param degrees The number of degrees to rotate a particle around the source
   * pos per second.
   */
  ...
  /** Switch between different kind of emitter modes:
   - kParticleModeGravity: uses gravity, speed, radial and tangential
   acceleration.
...
protected:
  ...
  */
  ...
  struct
  {
    ...
    float speedVar = 0;
    /** tangential acceleration of each particle. Only available in 'Gravity'
     * mode. */
    float tangentialAccel = 0;
  ...
  struct
  {
    ...
    float endRadius = 0;
    /** The ending radius variance of the particles. Only available in 'Radius'
     * mode. */
